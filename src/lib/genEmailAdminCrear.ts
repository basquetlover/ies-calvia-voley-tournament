...
export function generarEmailAdminCrear({email, rol,}:EmailVolAceProps){
                     ...
                     <tr>
                      <td align="left" style="padding:0;Margin:0" class="es-m-text"><h1 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:40px;font-style:normal;font-weight:normal;line-height:48px;color:#ffffff;text-align:center"><strong style="font-weight:700 !important">Benvingut/da a l'equip d'organització</strong></h1>
                       <table align="center" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;margin:12px auto 0">
                         <tr>
                          <td style="padding:0;Margin:0;width:64px;height:4px;background-color:#b2c5ff;border-radius:999px;font-size:0;line-height:0;color:#ffffff">&nbsp;</td>
                         </tr>
                       </table></td>
                     </tr>
                   </table></td>
                 ...
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" role="presentation" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                     <tr>
                      <td align="left" style="padding:0;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#ffffff;font-size:14px">Benvingut/da al sistema de gestió de l’IES Calvià Voley Tournament. <br> <br>El teu compte ha estat activat i ja disposes d’accés al panell d’administració. <br> <br>Des d’aquest sistema podràs gestionar les funcionalitats habilitades segons el teu nivell d’accés i col·laborar en l’organització del torneig.</p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
                 ...
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:560px">
                   <table cellspacing="0" role="presentation" width="100%" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                     <tr>
                      <td align="left" style="padding:16px;Margin:0;background-color:#1a1b20;border-left:4px solid #b2c5ff;border-radius:10px;margin-bottom:16px" class="es-m-text"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#cccccc;font-size:14px">ACCÉS CONFIRMAT</p><p class="es-text-mobile-size-24" style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:36px;letter-spacing:0;color:#b2c5ff;font-size:24px">Rol assignat: ${rol}</p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
