...
export function generarEmailVolAce({email, rol, nombre}:EmailVolAceProps){
        ...
        <table cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" class="es-footer-body" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;background-color:#FFFFFF;width:600px">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                ...
                <table cellspacing="0" role="presentation" width="100%" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                    <tr>
                    <td align="left" style="padding:16px;Margin:0;background-color:#1a1b20;border-left:4px solid #4ade80;border-radius:10px;margin-bottom:16px" class="es-m-text"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#cccccc;font-size:14px">ESTAT DE LA SOL·LICITUD</p><p class="es-text-mobile-size-24" style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:36px;letter-spacing:0;color:#4ade80;font-size:24px">ESTAT: ACCEPTAT</p></td>
                    </tr>
                </table></td>
                </tr>
            </table></td>
                ...
                <table cellpadding="0" cellspacing="0" role="presentation" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <td style="color: #c4c6d3; font-size: 14px; line-height: 1.5; margin-top: 8px; border: 2px dashed #b5c4ff33; padding: 16px; border-radius: 10px">
                            Ens posarem en contacte amb tu properament per coordinar els horaris i realitzar una petita sessió informativa.
                        </td>
                        </tr>
                    </table></td>
                    </tr>
