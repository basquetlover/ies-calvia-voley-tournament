type EmailVolAceProps = {
  email: string;
  rol: string;
  nombre: string;
};

export function generarEmailVolDen({email, rol, nombre}:EmailVolAceProps){
        ...
        <table cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" class="es-footer-body" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;background-color:#FFFFFF;width:600px">
            ...
            <table cellspacing="0" cellpadding="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                ...
                <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                    <tr>
                    <td align="left" style="padding:0;Margin:0" class="es-m-text"><h1 class="es-text-mobile-size-28" style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:28px;font-style:normal;font-weight:normal;line-height:34px;color:#ffffff;text-align:center"><strong style="font-weight:700 !important">Resultat de l'avaluació de voluntariat</strong></h1>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                ...
                <table cellspacing="0" role="presentation" width="100%" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                    <tr>
                    <td align="left" style="padding:16px;Margin:0;background-color:#1a1b20;border-left:4px solid #df4a4a;border-radius:10px;margin-bottom:16px" class="es-m-text"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#cccccc;font-size:14px">ESTAT DE LA SOL·LICITUD</p><p class="es-text-mobile-size-24" style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:36px;letter-spacing:0;color:#df4a4a;font-size:24px">ESTAT: DENEGAT</p></td>
                    </tr>
                </table></td>
                </tr>
            </table></td>
            ...
            <table cellspacing="0" width="100%" cellpadding="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                    <tr>
                    <td align="left" style="padding:16px;Margin:0;border:1px solid #33343a;border-radius:10px;margin-top:16px;background-color:#B2C5FF1A" class="es-m-text"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#b2c5ff;font-size:14px;margin:0">Rol assignat:</p><p class="es-text-mobile-size-18" style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:27px;letter-spacing:0;color:#e3e2e9;font-size:18px;margin:6px 0 0 0;font-weight:600">${rol}</p></td>
                    </tr>
                </table></td>
                </tr>
            </table></td>
            ...
            <table cellspacing="0" width="100%" cellpadding="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                ...
                <table cellpadding="0" cellspacing="0" role="presentation" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                    <tr>
                    <td align="left" style="padding:20px 0 0;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#b5c4ff;font-size:14px;margin:0;font-weight:bold">Propers passos</p>
                    <table cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                        <td style="color: #c4c6d3; font-size: 14px; line-height: 1.5; margin-top: 8px; border: 2px dashed #b5c4ff33; padding: 16px; border-radius: 10px">
                            La teva sol·licitud no ha pogut ser acceptada en aquesta ocasió. Això pot ser degut a la disponibilitat de places o a la revisió de les dades introduïdes. Pots consultar tots els detalls des del panell de voluntari.
                        </td>
                        </tr>
                    </table></td>
                    </tr>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                ...
                <table cellspacing="0" role="presentation" width="100%" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                    <tr>
                    <td align="center" style="padding:0;Margin:0"><a href="https://voley.iescalvia.com/usuario" target="_blank" class="es-button" style="mso-style-priority:100 !important;text-decoration:none;mso-line-height-rule:exactly;color:white;font-size:14px;padding:14px;display:block;background:#31CB4B;border-radius:8px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:bold;font-style:normal;line-height:17px;width:100%;text-align:center;letter-spacing:1px;mso-padding-alt:0;mso-border-alt:10px solid #31CB4B;background-color:#0140B9;max-width:85%">ACCEDIR AL PANEL DEL VOLUNTARI</a></td>
                    </tr>
                </table></td>
                </tr>
            </table></td>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                ...
                <table cellpadding="0" cellspacing="0" role="presentation" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                    <tr>
                    <td align="center" style="padding:0;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#666666;font-size:14px">©2026 IES Calvià Voley Tournament | Tots els drets reservats.</p></td>
                    </tr>
                </table></td>
                </tr>
            </table></td>
    ...
    <table cellspacing="0" cellpadding="0" align="center" class="es-content" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;width:100%;table-layout:fixed !important">
        ...
        <table bgcolor="#121318" align="center" cellpadding="0" cellspacing="0" class="es-content-body" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;background-color:#121318;width:600px" role="none">
            ...
            <table cellspacing="0" width="100%" cellpadding="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                    <tr>
                    <td align="left" class="es-m-text" style="padding:0 30px;Margin:0"><p class="es-text-mobile-size-10" style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;letter-spacing:0;color:#575757;font-size:12px;text-align:center">Heu rebut aquest correu perquè us heu registrat a la nostra web&nbsp;<a href="https://voley.iescalvia.com" target="_blank" style="mso-line-height-rule:exactly;text-decoration:underline;color:#575757;font-size:12px">voley.iescalvia.com</a>&nbsp;utilitzant el compte de correu&nbsp;<i>${email}</i>.</p></td>
                    </tr>
                </table></td>
                </tr>
                <tr>
                ...
                <table cellspacing="0" role="presentation" width="100%" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                    <tr>
                    <td align="left" class="es-m-text" style="padding:0 30px 10px;Margin:0"><p class="es-text-mobile-size-10" style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;letter-spacing:0;color:#575757;font-size:12px;text-align:center">Per a més informació sobre com tractem les vostres dades, podeu consultar el nostre <a href="https://voley.iescalvia.com/aviso-legal" target="_blank" style="mso-line-height-rule:exactly;text-decoration:underline;color:#575757;font-size:12px">Avís Legal</a>&nbsp;i&nbsp;<a href="https://voley.iescalvia.com/cookies" target="_blank" style="mso-line-height-rule:exactly;text-decoration:underline;color:#575757;font-size:12px">Política de Cookies</a>.</p></td>
                    </tr>
                </table></td>
                </tr>
            </table></td>
