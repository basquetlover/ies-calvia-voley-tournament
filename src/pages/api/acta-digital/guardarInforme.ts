...
export async function POST({ request }: { request: Request }) {
  const { informe, id_partido } = await request.json();

  console.log(informe, id_partido)
 ...
 const { data, error } = await supabaseAdmin
      ...
      .insert([
        { tipo_informe: informe.tipoInforme, 
          equipo_culpable: informe.culpable,
      ...
      if (error) {
        console.log(error)
            return new Response(JSON.stringify({ mensaje: error.message }), { status: 500 });
        }
                 ...
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="left" style="padding:0;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#FFFFFF;font-size:14px">${informe.contenido}</p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
