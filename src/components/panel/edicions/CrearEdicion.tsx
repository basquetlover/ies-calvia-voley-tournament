            ...
            data ? (
                <>
                    ...
                    <div className="max-w-150 w-full p-4 bg-gris-claro rounded-2xl">
                        ...
                        <div className="mt-5">
                            <p>Nom del torneig</p>
                            <input type="text" value={data.nombre} onChange={(e)=> handleChange( "nombre", e.target.value)} className="w-full rounded-xl items-center flex px-2 py-1 mt-2 h-10 bg-gris" />
                        </div>
                        <div className="mt-5">
