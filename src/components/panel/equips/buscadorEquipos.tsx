...
useEffect(() => {
  ...
  useEffect(() => {
    ...
    return(
        <>
        <div className="max-w-6xl mx-auto mt-10 h-auto grid grid-cols-[auto_1fr_1fr] gap-2">

            <div className="w-72 h-32 bg-gris-claro border-gray-600 border rounded-2xl flex flex-row items-center place-content-center gap-4 p-2">
            ...
            <div className="w-full h-32 bg-gris-claro border-gray-600 border rounded-2xl flex flex-col  gap-4 p-2">
                ...
                <div className="w-[90%]  mx-auto h-5 rounded-full flex overflow-hidden bg-gray-600/40">
                        ...
                        <div className="flex flex-row text-sm place-content-between">
        ...
        <div className="max-w-6xl mt-10 border border-gray-600 mx-auto h-32 rounded-2xl bg-gris-claro p-5 flex flex-wrap items-center place-content-between">
            ...
            <div className="w-64 rounded-2xl h-14 bg-gray-600 border border-gray-500 flex flex-row items-center gap-x-2">
        ...
        <div className="max-w-6xl mt-10 mx-auto h-auto rounded-2xl  p-5 flex flex-wrap items-center place-content-between">
            <div className="w-full h-10 border-b border-gray-700 grid grid-cols-[100px_1fr_1fr_150px_150px_150px] p-2 gap-2">
            ...
            <div className="w-full mt-2 flex flex-col gap-y-2">
                ...
                {
                    equipos.map((equipo) =>(
                        <div className="w-full h-24 rounded-xl bg-gris-claro border  border-gray-600 grid grid-cols-[100px_1fr_1fr_150px_150px_150px] items-center p-2 gap-2">
