                            ...
                            <div className="max-w-150 rounded-2xl flex flex-col gap-y-5 p-4 bg-gris-claro mx-auto mt-10 font-light">
                                    <div className="w-full flex flex-wrap place-content-between gap-x-4">
                                        <div className="flex flex-col gap-y-1">
                                            <p>Nom</p>
                                            <input onChange={(e)=> handleChange( "nombre", e.target.value)} value={data.nombre} className="w-65 px-2 py-1 bg-gris/40 rounded border border-gray-600" />
                                        </div>
                                        <div className="flex flex-col gap-y-1">
                                            <p>Curs</p>
                                    ...
                                    <div className="w-full flex flex-col gap-y-1">
                                        <p>Cognoms</p>
                                        <input onChange={(e)=> handleChange( "_1r_apellido", e.target.value)} value={data._1r_apellido + " " + data._2n_apellido} className="w-full px-2 py-1 bg-gris/40 rounded border border-gray-600" />
                                    </div>
                                    <div className="w-full flex flex-col gap-y-1">
                                        <p>Correu electrònic</p>
                                        <input onChange={(e)=> handleChange( "email", e.target.value)} value={data.email} className="w-full px-2 py-1 bg-gris/40 rounded border border-gray-600" />
                                    </div>
                                    ...
                                    <div className="w-full flex flex-col gap-y-1">
                                        <p>Observacions</p>
                                        <textarea placeholder="" className="w-full min-h-20 px-2 py-1 bg-gris/40 rounded border border-gray-600">{data.observacion}</textarea>
                                    </div>
                                    ...
                                    <div className="w-full grid grid-cols-2 gap-5">
                                        <div className="w-full h-16 cursor-pointer rounded px-3 bg-primary text-azul-suave fill-azul-suave flex hover:bg-accent duration-300 items-center place-content-center gap-x-2 font-medium">
                                            ...
                                            <p className="uppercase text-center">Guardar Canvis</p>
                                        </div>
                                        <a href={`/panel/voluntaris?torneoID=${torneoID}`} className="w-full h-16 cursor-pointer rounded px-3 flex hover:bg-red-600/30 duration-300 border border-red-400 text-red-400 fill-red-400 items-center place-content-center gap-x-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" viewBox="0 -960 960 960">
                                            ...
                                            <p className="uppercase text-center">Cancelar</p>
                                        </a>
                                    </div>
