export const CONTACTO = [
    {
        ...
        descripcion: 'Pere es uno de los encargados de la planificación general del torneo, asegurando que todo funcione de manera fluida. Es de los principal responsable de la logística y la coordinación con los equipos participantes.',
    },
    {
