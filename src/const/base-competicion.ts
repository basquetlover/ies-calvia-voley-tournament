export const BASES_COMPETICION = [
    ...
    { 
        titulo: '12. Composició Mixta Obligatòria',
        articulos:[
            {
    ...
    { 
        titulo: '13. Protocol d’Escalfament i Ús del Material',
        articulos:[
            {
    ...
    { 
        titulo: '14. Sistema de Competició i Classificació',
        articulos:[
            {
    ...
    { 
        titulo: '15. Gestió del Temps i Jornades de Joc',
        articulos:[
            {
    ...
    { 
        titulo: '16. Validació de Resultats',
        articulos:[
            {
